...
class MeteofranceWeatherCard extends LitElement {
  ...
  static async getConfigElement() {
    await import("./meteofrance-weather-card-editor2.js");
    return document.createElement("meteofrance-weather-card-editor2");
  }
  ...
  getWeatherIconHourly(condition, datetimehourly) {
    ...
    return `${this._config.icons
      ? this._config.icons
      : "/local/community/lovelace-meteofrance-weather-card2/icons/"
      }${datetimehourly && ((datetimehourly > nextsetting && datetimehourly < nextrising) || (datetimehourly < nextsetting && datetimehourly < nextrising ))
        ? weatherIconsNight[condition]
        : weatherIconsDay[condition]
      }.svg`;
  }
