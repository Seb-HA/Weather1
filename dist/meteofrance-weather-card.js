    ...
    return html` <li>
      <ul class="flow-column day">
        ...
        ${daily.wind_bearing !== undefined && daily.wind_bearing !== null
          ? html`			
			<li class="icon"
				style="background: none, url('/local/community/lovelace-meteofrance-weather-card/icons/arrow-north-static.svg'); background-size: contain; transform: rotate(${daily.wind_bearing - 360 }deg) scale(0.5)">
			  </li>
			  `
           : ""}
      </ul>
